    ...
    try:
        ...
        if not safe_urls:
            ...
            if provider is None or not provider.supports_extract():
                ...
                # plugin), fall through to the active-provider walk below.
            ...
            # Re-check the guard: a Tier-1 hit above swapped in Firecrawl,
            # which IS extract-capable, so skip the strict-selection walk
            # (that path is for "configured name isn't registered at all")
